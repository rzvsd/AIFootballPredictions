...
def run_hybrid_backtest():
    print(f"--- Starting Hybrid Model Backtest for League: {LEAGUE} ---")

    # --- 1. Load All Assets ---
    home_model_path = os.path.join('advanced_models', f'{LEAGUE}_xgb_home_model.pkl')
    away_model_path = os.path.join('advanced_models', f'{LEAGUE}_xgb_away_model.pkl')
    ...
    try:
        ...
        print("Successfully loaded models and enhanced data.")
    ...
    if 'B365H' in df.columns and 'B365D' in df.columns and 'B365A' in df.columns:
        ...
        print("Error: No recognized 1X2 odds columns found in the data (e.g., B365H or BWH).")
        return
