...
def convert_upcoming_to_odds(data_dir: str = "CGM data", out_dir: str = "data/odds", league: str = "E0") -> Path:
    ...
    if missing:
        raise ValueError(f"upcoming CSV is missing required columns: {missing}. Please use the rich CGM 'upcoming - Copy.CSV', not the lean fixtures CSV.")
